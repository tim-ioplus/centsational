...
public class AccountTest
{
    ...
    {
        var configFilePath = Environment.CurrentDirectory.Replace("bin/Debug/net8.0", testConfigFilePath);

        var serv = new AccountService();
        var c = serv.ReadConfiguration(configFilePath);
    ...
    {
        var configFilePath = Environment.CurrentDirectory.Replace("bin/Debug/net8.0", "TestConfig.csv");
    ...
    {
        var configFilePath = Environment.CurrentDirectory.Replace("bin/Debug/net8.0", "TestConfig2.csv");
        Assert.True(File.Exists(configFilePath));
